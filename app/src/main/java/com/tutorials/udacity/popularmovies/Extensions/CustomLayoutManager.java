package com.tutorials.udacity.popularmovies.Extensions;

/**
 * Created by asharma on 11/8/15.
 */
...
import com.tutorials.udacity.popularmovies.BuildConfig;
...
public class CustomLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public CustomLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public CustomLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
